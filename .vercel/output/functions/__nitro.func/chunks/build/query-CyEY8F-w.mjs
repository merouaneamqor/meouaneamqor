...
import { g as useNuxtApp, t as asyncDataDefaults, v as createError, d as useRuntimeConfig, m as withLeadingSlash, j as joinURL, c as withoutTrailingSlash$1, x as withBase, l as useRequestEvent } from './server.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-D6ptGbhZ.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-CyEY8F-w.mjs.map
