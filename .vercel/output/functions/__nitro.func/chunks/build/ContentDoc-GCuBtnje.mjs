...
import { d as useRuntimeConfig, w as withTrailingSlash$1, b as useRoute, j as joinURL, c as withoutTrailingSlash$1, h as hasProtocol } from './server.mjs';
import _sfc_main$2 from './ContentRenderer-ByeK65gK.mjs';
import _sfc_main$1 from './ContentQuery-COeyAYwK.mjs';
...
const useContentHead = (_content, to = useRoute()) => {
  ...
  const refreshHead = (data = content) => {
    ...
    if (host) {
      ...
      const url = config.public.content.trailingSlash ? withTrailingSlash$1(_url) : withoutTrailingSlash$1(_url);
...
const ContentDoc = defineComponent({
  ...
  render(ctx) {
    ...
    const contentQueryProps = {
      ...query || {},
      path: path || (query == null ? void 0 : query.path) || withTrailingSlash$1(useRoute().path),
      find: "one"
    };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/@nuxt+content@2.13.2_ioredis@5.4.1_magicast@0.3.5_nuxt@3.13.2_@parcel+watcher@2.4.1_@ty_fbcdca344b606d9f09a615635e2059c5/node_modules/@nuxt/content/dist/runtime/components/ContentDoc.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=ContentDoc-GCuBtnje.mjs.map
